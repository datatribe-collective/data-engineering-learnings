...
# -----------------------------------
# Local Paths from settings.yaml
# -----------------------------------
LOCAL_CSV_PATH = os.path.join(BASE_DIR, SETTINGS.get('parquet_output', {}).get('path', ''))
TMP_PARQUET_PATH = os.path.join(BASE_DIR, SETTINGS.get('tmp_parquet_path', ''))
SQL_FILE_PATH = os.path.join(BASE_DIR, SETTINGS.get('sql_file_path', ''))
